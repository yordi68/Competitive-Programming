...
<pre style="position: relative;"><strong>Input:</strong> logs = ["d1/","d2/","../","d21/","./"]
...
<pre style="position: relative;"><strong>Input:</strong> logs = ["d1/","d2/","./","d3/","../","d31/"]
<strong>Output:</strong> 3
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> logs = ["d1/","../","../","../"]
